...
void WoodenStandGenerator::prepareLeftBracketGenerator() {
    ...
    const glm::vec3 xTranslation = {-(basicModel.getInnerRadius() - basicModel.getBracketRadius()), 0.0f, 0.0f};
...
void WoodenStandGenerator::prepareLogGenerator() {
    ...
    const glm::vec3 yTranslation = glm::vec3{0.0f, basicModel.getBracketHeight() + basicModel.getHeight(), 0.0f};
